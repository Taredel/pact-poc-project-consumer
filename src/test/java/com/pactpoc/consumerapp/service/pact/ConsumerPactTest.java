...
public class ConsumerPactTest {
    ...
    V4Pact getSomething(PactBuilder builder) {
        DslPart body = new PactDslJsonBody()
                ...
                .stringValue("message", "This is a message"))
                .asBody();
    ...
    void getSomethingTest(MockServer mockServer) {
        SimpleDto expected = new SimpleDto(10, new MessageDto("This is a message"));
    ...
    void getSomethingElseTest(MockServer mockServer) {
        SimpleDto expected = new SimpleDto(25, new MessageDto("This is a message"));
        providerService.setUrl(mockServer.getUrl());
